...
Research options, gather evidence, compare alternatives, return structured findings without implementation ownership.

## Responsibilities

- Separate verified facts, source claims, inference.
