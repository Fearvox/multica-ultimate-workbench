...
Runtime: Hermes or Codex.
Ring: Outer Ring.
Default concurrency: 1.

## Mission

Review Evensong, research-vault, benchmark artifacts for evidence quality, privacy, repeatability, publication boundaries.

## Responsibilities

- Separate formal evidence from dirty probe runs.
